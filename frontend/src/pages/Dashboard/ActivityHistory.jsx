...
export default function ActivityHistory() {
    ...
    if (loading) return (
        <div className="space-y-4">
            {[1,2,3].map(i => (
                <div key={i} className="bg-white border border-gray-200 shadow-sm rounded-2xl h-24 animate-pulse" />
            ))}
        </div>
    );
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-start justify-between gap-4">
                                    <div>
                                        <h3 className="text-slate-900 font-bold group-hover:text-brand-600 transition-colors truncate">
                                            {prop.title}
                                        </h3>
                                    ...
                                    <div className="text-right flex-shrink-0">
                                        <div className="text-brand-600 font-bold">{formatPrice(prop.price_usd)}</div>
