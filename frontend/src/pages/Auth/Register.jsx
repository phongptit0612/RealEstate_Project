        ...
        <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden py-12">
            ...
            <div className="relative z-10 w-full max-w-md p-8 bg-white/10 backdrop-blur-xl border border-white/10 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.5)] mx-4">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 font-light">Tham gia LuxEstates ngay hôm nay</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="relative group">
                        ...
                        <input
                            type="tel" placeholder="Số điện thoại (tùy chọn)"
                    ...
                    <div className="relative group">
                        ...
                        <input
                            type="password" required placeholder="Mật khẩu (ít nhất 6 ký tự)"
                ...
                <div className="mt-8 text-center text-gray-400 text-sm">
                    Đã có tài khoản? <Link to="/login" className="text-ocean-400 font-bold hover:text-ocean-200 ml-1">Đăng nhập</Link>
                </div>
            </div>
        </div>
    );
