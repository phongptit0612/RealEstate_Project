        ...
        <div className="min-h-screen flex items-center justify-center bg-[#020813]">
            <div className="bg-[#051124] border border-white/10 rounded-3xl p-10 max-w-md w-full mx-6 text-center shadow-2xl">
                ...
                <button
                    ...
                    className="w-full bg-[#0033ab] hover:bg-[#002273] text-white font-bold py-3 rounded-xl transition-colors"
                >
                    Sign In Now
                </button>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-[#020813] border border-white/10 rounded-xl py-3 px-4 text-white text-sm font-mono tracking-[0.3em] text-center placeholder:text-slate-600 placeholder:tracking-normal focus:outline-none focus:border-[#0033ab] focus:ring-1 focus:ring-[#0033ab] transition-all"
                            />
                        </div>
                        ...
                        <button
                            ...
                            className="w-full bg-[#0033ab] hover:bg-[#002273] disabled:opacity-50 text-white font-bold py-3.5 rounded-xl transition-colors mt-2"
                        >
